...
<head>
    <meta charset="utf-8">
    <title>Reporte de Estado del Residente</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="title">
            ...
            <h2>Reporte de Estado del Residente</h2>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>DESCRIPCION DE ESTADO DE RESIDENTES</th>
                </tr>
        </thead>
        <tbody>
        
       
        @foreach($EstadoPersona as $index => $estado)
            <tr>
