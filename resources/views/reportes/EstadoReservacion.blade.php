...
<head>
    <meta charset="utf-8">
    <title>Reporte de Estado de Reservacion</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="title">
            ...
            <h2>Reporte de Estado de Reservacion</h2>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>DESCRIPCION DE ESTADO DE RESERVACION</th>
                </tr>
        </thead>
        <tbody>
        
       
        @foreach($EstadoReservacion as $index => $estado)
            <tr>
