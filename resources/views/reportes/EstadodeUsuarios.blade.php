...
<head>
    <meta charset="utf-8">
    <title>Reporte de Estado del Usuario</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="title">
            ...
            <h2>Reporte de Estado del Usuario</h2>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>DESCRIPCION DE ESTADO DE USUARIO</th>
                </tr>
        </thead>
        <tbody>
        
       
        @foreach($EstadodeUsuario as $index => $estado)
            <tr>
