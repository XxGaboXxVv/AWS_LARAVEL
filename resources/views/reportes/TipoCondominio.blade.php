...
<head>
    <meta charset="utf-8">
    <title>Reporte de Tipo de Condominio</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="title">
            ...
            <h2>Reporte de Tipo de Condominio</h2>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>DESCRIPCION DE TIPO DE CONDOMINIO</th>
                </tr>
        </thead>
        <tbody>
        
       
        @foreach($tipoCondominio as $index => $tipoCondominio)
            <tr>
